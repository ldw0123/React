...
var superPrint4 = function (arrayyy) { return arrayyy[0]; }; // superPrint3함수는 배열의 첫 번째 요소의 타입과 동일한 타입을 반환 -> T
var e = superPrint4([1, 2, 3, 4], 'x'); // T(반환 타입)는 number로, M은 string으로 유추
var f = superPrint4([true, false, true], 1); // T는 boolean으로, M은 number으로 유추
var g = superPrint4(['a', 'b', 'c'], false); // T는 string, M은 boolean으로 유추
var h = superPrint4([1, 2, true, false, '2'], []); // T는 number, M은 never[]으로 유추
